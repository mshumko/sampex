.. sampex documentation master file, created by
   sphinx-quickstart on Sat Jul  9 15:10:08 2022.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to sampex's documentation!
==================================

**Last Built**: |today| | **Version**: |version| | **Source**: `github`_ | **Archive**: `pypi`_.
